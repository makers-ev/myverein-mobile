...
import { Bell, Calendar, Home as HomeIcon, Settings as SettingsIcon, Users, type LucideIcon } from 'lucide-react-native';
...
interface NavItem {
    route: 'Home' | 'Verein' | 'Kalender' | 'Notifications' | 'Settings';
    labelKey: string;
    Icon: LucideIcon;
}

// Adding a destination is appending one object here, nothing else in this
// component changes. `Verein`/`Kalender`/`Notifications` are gated by
// `RequireAuth` (see AppNavigator.tsx) -- a guest tapping any of them is
// redirected to Login, same as any other gated screen reached from an
// ungated nav entry.
